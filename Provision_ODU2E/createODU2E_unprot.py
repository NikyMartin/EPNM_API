...
from getCreatePayload_4K_End import createPayload_4K_End  # Combined createPayload_4K_A() and createPayload_4K_Z()
from getCreatePayload_2K_End import createPayload2Kend  # Combined createPayload_2K_A() and createPayload_2K_Z()
...
# EPNM Template names
templateName4Kend_A = "CREATE_UNPROT_ODU2E_4kendpoint_A"
templateName4Kend_Z = "CREATE_UNPROT_ODU2E_4kendpoint_Z"
templateName2Kend_A = "CREATE_UNPROT_ODU2E_2kendpoint_A"
templateName2Kend_Z = "CREATE_UNPROT_ODU2E_2kendpoint_Z"
...
# Checking if payload protection is "unprotected"

protection = getFileProtection(json_file)
if protection != "unprotected":
    print("\nERROR: Found protected service. Expected unprotected")
...
if a_end_node_type == "4K":
    ...
    paramListAend = createPayload_4K_End(input_file, service_name, service_id, sourceNodeID, "A-End", "unprotected")
...
if a_end_node_type == "2K":
    ...
    paramListAend = createPayload2Kend(input_file, service_name, service_id, sourceNodeID, "A-End", "unprotected",
                                       epnm_ip, epnm_username, epnm_password)
    status, jobDetails = executeTemplate(epnm_ip, epnm_username, epnm_password, a_end_node_name, deviceID_a_end,
                                         templateName2Kend_A, paramListAend)
    if not status:
        print("ERROR: cannot deploy template ", templateName2Kend, "on device", a_end_node_name)
        print("Terminating script execution")
        print("Check logs for more")
        exit(1)
...
if z_end_node_type == "2K":
    ...
    paramListZend = createPayload2Kend(input_file, service_name, service_id, sourceNodeID, "Z-End", "unprotected",
                                       epnm_ip, epnm_username, epnm_password)  # last 3 param here are not needed
...
if z_end_node_type == "4K":
    print("\nDeploy template on Z endpoint", z_end_node_name)
    paramListZend = createPayload_4K_End(input_file, service_name, service_id, sourceNodeID, "Z-End", "unprotected")
