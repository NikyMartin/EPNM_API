"""
    ...
    April 28th
    Added deletePayload_unprot_2Kend function
    - Could combine both in one function but risk
...
def deletePayload2Kend(input_file,AZend,protection):
    f = open(input_file, 'r')
    content_file = f.read()
    f.close()
...
# param_list = deletePayload2Kend("validate_input_file_example.json",""A-End"")
