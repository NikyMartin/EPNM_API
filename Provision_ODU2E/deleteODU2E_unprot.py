...
# "deletePayload_unprot_4K" Creates the required payload to execute
# "DELETE_UNPROT_ODU2E_4kendpoint_A" EPNM template on 4K
...
# Templates have anyway different syntax
...
# EPNM Template names
templateName4Kend = "DELETE_UNPROT_ODU2E_4kendpoint"  # should be good for 4K A or Z end
templateName2Kend_A = "DELETE_UNPROT_ODU2E_2kendpoint_A"
templateName2Kend_Z = "DELETE_UNPROT_ODU2E_2kendpoint_Z"
...
if a_end_node_type == "4K":
    ...
    paramListAend = deletePayload_4K_End(input_file, "A-End", "unprotected")
...
if a_end_node_type == "2K":
    ...
    paramListAend = deletePayload2Kend(input_file, "A-End", "unprotected")
...
if z_end_node_type == "2K":
    ...
    paramListZend = deletePayload2Kend(input_file, "Z-End", "unprotected")
...
if z_end_node_type == "4K":
    print("\nDeploy template on Z endpoint", z_end_node_name)
    paramListZend = deletePayload_4K_End(input_file, "Z-End", "unprotected")
    status, jobDetails = executeTemplate(epnm_ip, epnm_username, epnm_password, z_end_node_name, deviceID_z_end,
...
for isWorking in (True,False):  # This way I can define one loop for both paths
    ...
    if not empty:
        ...
        for node in range(0, numnodes):
            ...
            if nodeType == "2K":
                status, jobDetails = executeTemplate(delete_ip, epnm_username, epnm_password, deviceNameMid,deviceIDMid,
