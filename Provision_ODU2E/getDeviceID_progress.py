...
def getDeviceID(epnm_ip,user,pwd):
    ...
    while page - last_index < 2:
        if page == 0:
            url = 'https://' + epnm_ip + '/webacs/api/v4/data/Devices'
        else:
            url = 'https://' + epnm_ip + '/webacs/api/v4/data/Devices?.firstResult=' + str(page)
...
if __name__ == '__main__':
    ...
    if len(sys.argv)!=2:
      print('\nMust pass EPNM IP address as script argument\n')
      exit()
